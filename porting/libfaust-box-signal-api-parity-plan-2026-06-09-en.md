...
The check builds and packages `faust-ffi`, extracts native dynamic exports from
the produced `libfaust-rs` library, compares them with the maintained Box/Signal C headers, and
...
`target/debug/libfaust-rs.dylib`.
