...
- The temporary output-arity fallback based on `Drop` counting has been removed.
- Current rule: FIR module metadata carries authoritative `num_inputs` / `num_outputs`.
