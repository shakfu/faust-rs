...
public:
    ...
    virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
        ...
        for (int i0 = 0; i0 < count; ++i0) {
            int iRecCur43 = (iRec43 + 1);
            output0[i0] = ((FAUSTFLOAT)(fTbl94[(iRec43 % 64)]));
            output1[i0] = ((FAUSTFLOAT)(fTbl99[(iRec43 % 32)]));
            iRec43 = iRecCur43;
        }
    }
};
