...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
    ...
    for (int i0 = 0; i0 < count; i0 = i0 + 1) {
        int iRecCur39 = (dsp->iRec39 + 1);
        output0[i0] = ((FAUSTFLOAT)(fTbl82[(dsp->iRec39 % 64)]));
        output1[i0] = ((FAUSTFLOAT)(fTbl82[((dsp->iRec39 + 7) % 64)]));
        dsp->iRec39 = iRecCur39;
    }
}
