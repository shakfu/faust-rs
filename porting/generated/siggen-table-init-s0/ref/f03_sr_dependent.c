...
static void fillmydspSIG0(mydspSIG0* dsp, int count, float* table) {
	/* C99 loop */
	{
		...
		for (i1 = 0; i1 < count; i1 = i1 + 1) {
			...
			table[i1] = expf(-(dsp->fConst0 * (float)(dsp->iRec0[1])));
...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "filename", "f03_sr_dependent.dsp");
	m->declare(m->metaInterface, "maths.lib/author", "GRAME");
	m->declare(m->metaInterface, "maths.lib/copyright", "GRAME");
	m->declare(m->metaInterface, "maths.lib/license", "LGPL with exception");
	m->declare(m->metaInterface, "maths.lib/name", "Faust Math Library");
	m->declare(m->metaInterface, "maths.lib/version", "2.9.0");
	m->declare(m->metaInterface, "name", "f03_sr_dependent");
...
void instanceConstantsmydsp(mydsp* dsp, int sample_rate) {
	dsp->fSampleRate = sample_rate;
	dsp->fConst1 = 2.0f / fminf(1.92e+05f, fmaxf(1.0f, (float)(dsp->fSampleRate)));
}
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	ui_interface->openVerticalBox(ui_interface->uiInterface, "f03_sr_dependent");
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
	...
	/* C99 loop */
	{
		...
		for (i0 = 0; i0 < count; i0 = i0 + 1) {
			dsp->iVec0[0] = 1;
			float fTemp0 = ((1 - dsp->iVec0[1]) ? 0.0f : dsp->fConst1 + dsp->fRec1[1]);
			dsp->fRec1[0] = fTemp0 - floorf(fTemp0);
			output0[i0] = (FAUSTFLOAT)(ftbl0mydspSIG0[faustmaxi(0, faustmini((int)(1024.0f * dsp->fRec1[0]), 1023))]);
