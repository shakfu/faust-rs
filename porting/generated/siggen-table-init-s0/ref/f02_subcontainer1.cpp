...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "f02_subcontainer1.dsp");
		m->declare("name", "f02_subcontainer1");
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("f02_subcontainer1");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iRec0[0] = iRec0[1] + 1;
			output0[i0] = static_cast<FAUSTFLOAT>(ftbl0mydspSIG0[std::max<int>(0, std::min<int>(iRec0[1] % 100, 99))]);
			iRec0[1] = iRec0[0];
		}
	}
