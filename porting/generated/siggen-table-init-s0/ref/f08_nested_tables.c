...
static void fillmydspSIG0(mydspSIG0* dsp, int count, float* table) {
	/* C99 loop */
	{
		...
		for (i1 = 0; i1 < count; i1 = i1 + 1) {
			...
			table[i1] = ftbl0mydspSIG0SIG0[faustmaxi(0, faustmini(dsp->iRec1[1] % 64, 63))];
...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "filename", "f08_nested_tables.dsp");
	m->declare(m->metaInterface, "maths.lib/author", "GRAME");
	m->declare(m->metaInterface, "maths.lib/copyright", "GRAME");
	m->declare(m->metaInterface, "maths.lib/license", "LGPL with exception");
	m->declare(m->metaInterface, "maths.lib/name", "Faust Math Library");
	m->declare(m->metaInterface, "maths.lib/version", "2.9.0");
	m->declare(m->metaInterface, "name", "f08_nested_tables");
...
void classInitmydsp(int sample_rate) {
	...
	fillmydspSIG0(sig0, 64, ftbl1mydspSIG0);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
	...
	/* C99 loop */
	{
		...
		for (i0 = 0; i0 < count; i0 = i0 + 1) {
			dsp->iVec0[0] = 1;
			float fTemp0 = ((1 - dsp->iVec0[1]) ? 0.0f : dsp->fConst0 + dsp->fRec2[1]);
			dsp->fRec2[0] = fTemp0 - floorf(fTemp0);
			output0[i0] = (FAUSTFLOAT)(ftbl1mydspSIG0[faustmaxi(0, faustmini((int)(64.0f * dsp->fRec2[0]), 63))]);
