...
declare basics_lib_version "<lib>";
declare filename "020_library_import.dsp";
declare maths_lib_author "<lib>";
declare maths_lib_copyright "<lib>";
declare maths_lib_license "<lib>";
declare maths_lib_name "Faust Math Library";
declare maths_lib_version "<lib>";
declare name "LibImport";
declare oscillators_lib_name "Faust Oscillator Library";
declare oscillators_lib_version "<lib>";
declare platform_lib_name "Generic Platform Library";
declare platform_lib_version "<lib>";
ID_0 = (65536 : int);
ID_1 = _, ID_0;
ID_2 = (ID_1 : %);
ID_3 = (1 : mem);
