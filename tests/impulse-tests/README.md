...
Full sweep over the 93 DSPs at the default `2e-06` tolerance:
...
(91), `make cranelift` (81), `make interp` (82) build and pass; excluded cases
(e.g. C `grain3`, Cranelift `prefix`) are documented to fix later.
